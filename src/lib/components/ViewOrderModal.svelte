...
<dialog
    class="modal modal-bottom sm:modal-middle print:modal-none"
    class:modal-open={showModal}
>
    <div
        class="modal-box w-11/12 max-w-5xl print:w-full print:max-w-none print:m-0 print:p-0 print:shadow-none"
    >
        <!-- Print-only header -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
                ...
                <div
                    ...
                    class:badge-warning={order?.status === "Pendente" ||
